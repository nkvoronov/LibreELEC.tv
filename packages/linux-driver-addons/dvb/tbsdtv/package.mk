...
if [ "${TBSDTV_EXT}" = "yes" ]; then
   PKG_VERSION="20220423"
   PKG_SHA256="ae0288b37bbc0c1f09fb29554601c47df44c79c797641cdd50ed4bdc859d2eab"
   PKG_URL="https://www.dropbox.com/s/weockpmt3lm9050/${PKG_NAME}-${PKG_VERSION}.tar.gz"
else
   PKG_VERSION="945eea7"
