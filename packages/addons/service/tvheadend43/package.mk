...
addon() {
  TVHEADEND_DIR=$(get_install_dir tvheadend)
...
# set only version (revision will be added by buildsystem)
  ...
  cp -P $TVHEADEND_DIR/usr/bin/tvheadend ${ADDON_BUILD}/${PKG_ADDON_ID}/bin
  cp -P $TVHEADEND_DIR/usr/lib/capmt_ca.so ${ADDON_BUILD}/${PKG_ADDON_ID}/bin
