...
addon() {
  mkdir -p ${ADDON_BUILD}/${PKG_ADDON_ID}/data
    ...
    cp -p $(get_install_dir openjpeg2)/usr/bin/opj_dump ${ADDON_BUILD}/${PKG_ADDON_ID}/data/opj_dump.bin

    cp -p $(get_install_dir lcms2)/usr/bin/jpgicc ${ADDON_BUILD}/${PKG_ADDON_ID}/data/jpgicc.bin
    cp -p $(get_install_dir lcms2)/usr/bin/linkicc ${ADDON_BUILD}/${PKG_ADDON_ID}/data/linkicc.bin
    cp -p $(get_install_dir lcms2)/usr/bin/psicc ${ADDON_BUILD}/${PKG_ADDON_ID}/data/psicc.bin
    cp -p $(get_install_dir lcms2)/usr/bin/tificc ${ADDON_BUILD}/${PKG_ADDON_ID}/data/tificc.bin
